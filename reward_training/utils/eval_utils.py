...
def compute_rewind_reward(rewind_model, args, episode_image_embeddings, lang_embeddings, threshold=0.5, pdf_path="incremental_reward_rewind.png", epoch=0, suboptimal_type = "all_fail"):
    ...
    for i in range(1, episode_image_embeddings.shape[0]+1):
        ...
        pred_class, _ = rewind_model(processed_video_embedding, lang_embeddings)
