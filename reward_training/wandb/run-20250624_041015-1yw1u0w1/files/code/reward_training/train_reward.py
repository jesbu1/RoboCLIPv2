...
def main(args):
    ...
    if args.extra_data_type == "metaworld":
        if args.text_embedding_model == "minilm":
            h5_train_eval_file = h5py.File("data/metaworld_train_embeddings.h5", "r")
            h5_eval_file = h5py.File("data/metaworld_eval_embeddings.h5", "r")
            extra_data_path = "data/metaworld_train_embeddings.h5"
