...
def load_rewind_model(ckpt_path: str = "/scr/yusenluo/RoboCLIP/visualization/decoder_only/roboclip_v2_decoder_models_fix_3rd/RegressionFixTransformer5Demos_liv_sample_neg_heads_4_SampleNeg_ReverseVideo_norm_PositionalEncoding_500/model_199.pth") -> torch.nn.Module:
    # 1️⃣ 设定 `ckpt_path`
    embedding_dim = 1024
...
if __name__ == "__main__":
    ...
    h5_eval_file = h5py.File("/scr/yusenluo/RoboCLIP/visualization/decoder_only/metaworld_GT_eval_v2.h5", "r")
     # ============ 1) 生成 NxN 预测矩阵 =============
