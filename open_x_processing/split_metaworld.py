...
import h5py
h5_file_name = "metaworld_liv_embeddings_224.h5"
...
h5_train_file = h5py.File("metaworld_liv_embeddings_train.h5", 'w')
h5_eval_file = h5py.File("metaworld_liv_embeddings_eval.h5", 'w')
