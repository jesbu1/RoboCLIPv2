...
import imageio
from generated_text_no_robot import generate_set_6_ann_v2, gt_annotations_v2
...
def main(model_name, generated_text, gt_text):
    ...
    # add data
    data_file = h5py.File("/scr/jzhang96/metaworld_25_for_clip_liv_norobot_test.h5", "a")
    ...
    for env_name in tqdm(generated_text.keys()):
        ...
        if text_env_name in model_group.keys():
            del model_group[text_env_name]
