...
import math
from clip_utils import TwoLayerMLP, TwoLayerMLPClass
...
class MultiHeadAttentionClass(nn.Module):
    def __init__(self, embed_dim, num_heads, num_class, dropout=0.1):
        ...
        self.classifier = TwoLayerMLPClass(embed_dim, num_class)
