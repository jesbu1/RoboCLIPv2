...
def RankLoss(
        ...
        soft_margin_loss,
        hard_margin_loss,
        hard_margin_loss_type="soft_margin",
...
def main(args):
    ...
    experiment_name = "RankMarginLoss_" + args.model_name + args.hard_margin_loss
