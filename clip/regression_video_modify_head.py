...
import os
from self_attention_utils import SingleHeadAttentionWithPositionalEncoding, SingleHeadAttentionWithOutPositionalEncoding, SingleHeadAttentionWithPositionalEncodingModify
...
def main(args):
    ...
    run = wandb.init(
        ...
        group="RegressionRandomStartVideoSelfAttentionLossSubstractionNewModifyWeighted",
        config=args,
    ...
    if args.model_name == "clip":
        ...
        if args.position_encoding:
            self_attention_model = SingleHeadAttentionWithPositionalEncodingModify(768).to(device)
        else:
        ...
        if args.position_encoding:
            self_attention_model = SingleHeadAttentionWithPositionalEncodingModify(1024).to(device)
        else:
