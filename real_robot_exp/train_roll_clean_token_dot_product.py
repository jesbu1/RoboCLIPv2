    ...
    for epoch in range(args.epochs):
        ...
        if args.openx_data:
            for openx_data, extra_data in tqdm(zip(openx_dataloader, extra_dataloader), total = 100):
                ...
                negative_text_mask_1 = positive_text_mask.clone()
                ...
                openx_pos_text_mask = torch.cat([positive_text_mask[:openx_len], negative_text_mask_1[:openx_len]], dim = 0)
                ...
                extra_pos_text_mask = torch.cat([positive_text_mask[openx_len:], negative_text_mask_1[openx_len:]], dim = 0)
