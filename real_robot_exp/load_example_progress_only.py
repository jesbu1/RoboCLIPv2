...
import h5py
# Load the model
model_path = os.path.join('/home/jzhang96/RoboCLIPv2/real_robot_exp','models', 'metaworld_PosEmb_View_side_OpenX_Rewind_ratio_0.8_EMA_momentum_0.3_End_Rewind_ratio_0.1', 'model_0.pth')
