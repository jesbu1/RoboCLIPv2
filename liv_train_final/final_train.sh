...
python reward_model_training.py --sample_neg  --attention_heads 4 --reverse_video --normalize_embedding --enlarge_embedding_space --cat_embedding & 
python reward_model_training.py --sample_neg  --attention_heads 4 --reverse_video --normalize_embedding --catagorical_progress_bins 5 --catagorical_progress --enlarge_embedding_space --cat_embedding &
wait
