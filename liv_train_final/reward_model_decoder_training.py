...
def main(args):
    ...
    experiment_name = "RegressionFixTransformer_" + args.model_name 
    ...
    dataset = LivVideoDecoderDataset(args, h5_file)
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % 20 == 19:
            ...
            save_path = os.path.join("/scr/jzhang96/roboclip_v2_decoder_models_fix_2nd", experiment_name)
