...
from confusion_matrix_decoder import plot_confusion_matrix_pca_class
...
def main():
    ...
    model_base_path = "/scr/jzhang96/roboclip_v2_decoder_models_fix_3rd"
    model_name = f"RegressionFixTransformer5Demos_liv_sample_neg_heads_4_SampleNeg_ReverseVideo_norm_500"
    eval_epoch = 199
    ...
    wandb.init(
        ...
        group="roboclip_v2_decoder_models_fix_3rd",
        config=args,
        name=model_name + "_" + epoch_name
        )
