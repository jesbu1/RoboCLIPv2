...
python metaworld_envs_s3d_text_transform.py --n_envs 8 --wandb --time --norm_input --norm_output --time_reward 100 --entropy_term "auto" --random_reset --eval_freq 1280 --video_freq 5120 --seed 5 --algo "sac" --env_id 'door-open-v2-goal-hidden' --text_string 'opening door' --transform_model_path "triplet_loss_50_42_s3d_TimeShuffle_TimeShort_Normtriplet/1650.pth" --exp_name_end "Triplet_ours_RE" --total_time_steps 1000000 --succ_end & 
