...
def main():
    ...
    for seed_str in seed_num:
        model = SAC.load(f"/scr/jzhang96/logs/baseline_logs/s3d_textTrans_TRIPLETsac_button-press-v2-goal-hidden_SuccEnd_Triplet_ours_Long_{seed_str}NEW/best_model.zip")
