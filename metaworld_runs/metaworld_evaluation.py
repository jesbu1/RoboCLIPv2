...
def main():
    ...
    for seed_str in seed_num:
        model = SAC.load(f"/scr/jzhang96/logs/baseline_logs/s3d_textTrans_sac_door-close-v2-goal-hidden_NormIn_NormOut_XReward100.0_NoTime_RandReset_Entropyauto_{seed_str}NEW/best_model.zip")
